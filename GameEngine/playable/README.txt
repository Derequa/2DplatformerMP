Derek Batts - CSC 481 - Fall 2015 - Homework 3

To play this import the zipped project into eclipse, run the server through the GameManager class, and the client
